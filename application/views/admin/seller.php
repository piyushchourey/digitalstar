<div class="pageheader">
	<div class="row">
		<div class="col-md-8">
			<h2 class="pull-left">
				<i class="glyphicon glyphicon-user"></i><?php echo $sel; ?>
				<span>List</span>
			</h2>
		</div>
		<div class="col-md-4">
			<a class="btn btn-success pull-right" href="<?php echo base_url('seller/registration'); ?>">Registration</a>
		</div>
	</div>
</div>
          ...
          $.ajax({
            ...
            success: function(result)
            {
                ...
                if(result != "")
				{
					...
					{
							$.growl.notice({title: "<i class='fa fa-times'> Sorry.. </i>", message: res.msg });
					}
