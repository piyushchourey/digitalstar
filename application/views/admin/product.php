...
<div class="pageheader">
	<div class="row">
		<div class="col-md-8">
			<h2 class="pull-left">
				<i class="fa fa-cube"></i><?php echo $sel; ?>
				<span>List</span>
			</h2>
		</div>
		<div class="col-md-4">
			<a class="btn btn-success pull-right" href="<?php echo base_url('product/create'); ?>">Add</a>
		</div>
	</div>
</div>
	...
	<div class="row">
        ...
        <div class="table-responsive">
			...
			<table class="table table2excel table-striped" id="table2">
					...
					<?php if(!empty($all_prdct))

					{

						$i=1;
						foreach($all_prdct as $r)
						{ ?>
							...
							<tr id="row_<?php echo $r['id']; ?>">
								...
								<td> <?php echo $i++; ?></td>
								<td> 
									<img class="img-responsive img-thumbnail prdct_img" src="<?php echo base_url('images/products') ?>/<?php echo $r['image']; ?>" alt="<?php echo $r['name']; ?>">
								</td>
								<td> <?php echo ucfirst($r['category_name']); ?></td>
								<td> <?php echo ucfirst($r['name']); ?></td>
								<td> <i class="fa fa-inr"></i><?php echo $r['price']; ?></td>
								<td> <?php echo ucfirst($r['description']); ?></td>
								<td>
									<?php if($r['status'])
									{ ?>
