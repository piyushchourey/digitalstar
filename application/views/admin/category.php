<div class="pageheader">
	<div class="row">
		<div class="col-md-8">
			<h2 class="pull-left">
				<i class="fa fa-list"></i><?php echo $sel; ?>
				<span>List</span>
			</h2>
		</div>
		<div class="col-md-4">
...

					{
						...
						{ ?>
							...
							<tr id="row_<?php echo $r['id']; ?>">
								...
								<td> <?php echo ucfirst($r['category_type']); ?></td>
      ...
      <div class="modal-body">
				...
				<select name="category_type" class="form-control" id="category_type">
					...
					<?php if(!empty($cat_type_info))
					{
						foreach ($cat_type_info as $cat) { ?>
							<option value="<?php echo $cat['id']; ?>"><?php echo ucfirst($cat['type_name']); ?></option>
						<?php }
					}
					?>
				</select>
        	...
        	<div class="form-group">
				<div class="">
					...
					<input class="form-control valid" type="text" name="name" id="categoryName" required="" placeholder="Category Name">
			...
			<div class="form-group">
				<div class="">
					...
					<input class="form-control valid" type="file" name="cat_img" id="cat_img" required>
					<label for="cat_img" class="error"></label><br>
				</div>
			</div>
			<div class="form-group">
